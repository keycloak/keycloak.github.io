...
<div class="page-section">
    <div class="container">
        ...
        <p>
            For questions and if you're running into trouble, please join our
        ...
        <p>
           To report a bug or request a new feature file an issue in <a href="https://issues.jboss.org/browse/KEYCLOAK" target="_blank">JIRA</a>.
        </p>

        <p>
            You can also join us on FreeNode in the <a href="irc://irc.freenode.net/#keycloak" target="_blank">#keycloak</a> <channel class=""></channel>
        </p>
        ...
        <ul>
            ...
            <li><a href="irc://irc.freenode.net/#keycloak" target="_blank">IRC (#keycloak on Freenode)</a></li>
        </ul>
